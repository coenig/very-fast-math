...
@{@{./examples/exp4_time_2000_dist_4000_mintimeBetweenLC_1/detailed_archive/run_5/iteration_1}@.findFilesRecursively[debug_trace_array.txt]}@*.setScriptVar[temp_var, force].nil
