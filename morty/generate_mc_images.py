...
@{@{./examples/exp4_time_2000_dist_4000_mintimeBetweenLC_1/detailed_archive/}@.findFilesRecursively[debug_trace_array.txt]}@*.setScriptVar[temp_var, force].nil
@{@{[i]}@.replaceAll[\, /].removeLastFileExtension[/].generateTestCasesPlain[cex-birdseye, debug_trace_array, ./examples/exp4_time_2000_dist_4000_mintimeBetweenLC_1/detailed_archive/scaling_info.txt]
