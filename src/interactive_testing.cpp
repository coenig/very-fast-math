   ...
   const std::shared_ptr<RoadGraph> ego_section)
{
   ...
   StraightRoadSection sectiona1{ 4, 4, 50 };
   StraightRoadSection sectiona2{ 4, 4, 60 };
   StraightRoadSection sectiona3{ 4, 4, 100 };
   StraightRoadSection sectiona4{ 4, 4, 55 };
...
std::shared_ptr<RoadGraph> vfm::test::paintExampleRoadGraphRoundabout(const bool write_to_files, const std::shared_ptr<RoadGraph> ego_section)
{
   ...
   StraightRoadSection section0{ lanes0, lanes0, 50 };
   StraightRoadSection section1{ lanes1, lanes1, 50 };
   StraightRoadSection section2{ lanes2, lanes2, 50 };
   StraightRoadSection section3{ lanes3, lanes3, 50 };
   StraightRoadSection section4{ lanes4, lanes4, 50 };
   StraightRoadSection section5{ lanes5, lanes5, 50 };
   StraightRoadSection section6{ lanes6, lanes6, 50 };
   StraightRoadSection section7{ lanes7, lanes7, 50 };
