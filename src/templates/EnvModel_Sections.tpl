...
INVAR veh___6[i]9___.rel_pos >= -33 & veh___6[i]9___.rel_pos < @{17 + 50 / 3 * NONEGOS}@.eval[0];
@{INIT ego.same_lane_as_veh_[i] & veh___6[i]9___.rel_pos > 0;}@.if[@{[i] < 2 * NONEGOS / 3}@.eval]
