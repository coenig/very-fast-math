...
MODULE main
  VAR
    ...
    sec3 : Section1Conn(max_secparts_per_sec, 3);
    sec4 : SectionSink(max_secparts_per_sec, 4);
  ...
  CarCoreDecl(car2, max_sec_id, max_secparts_per_sec)

  -- TODO: Do I really need this constraint???
  INVAR ! (same_sec(car0, car1) & car0.on_secpart = car1.on_secpart);
  INVAR ! (same_sec(car0, car2) & car0.on_secpart = car2.on_secpart);
  INVAR ! (same_sec(car1, car2) & car1.on_secpart = car2.on_secpart);

  DEFINE
    car0_will_travese_from_sec0 := will_traverse(car0, 0);
    car1_will_travese_from_sec0 := will_traverse(car1, 0);
    car2_will_travese_from_sec0 := will_traverse(car2, 0);
    car0_will_travese_from_sec1 := will_traverse(car0, 1);
    car1_will_travese_from_sec1 := will_traverse(car1, 1);
    car2_will_travese_from_sec1 := will_traverse(car2, 1);
    car0_will_travese_from_sec2 := will_traverse(car0, 2);
    car1_will_travese_from_sec2 := will_traverse(car1, 2);
    car2_will_travese_from_sec2 := will_traverse(car2, 2);
    car0_will_travese_from_sec3 := will_traverse(car0, 3);
    car1_will_travese_from_sec3 := will_traverse(car1, 3);
    car2_will_travese_from_sec3 := will_traverse(car2, 3);

    car0_will_travese_from_sec4 := will_traverse(car0, 4);
    car1_will_travese_from_sec4 := will_traverse(car1, 4);
    car2_will_travese_from_sec4 := will_traverse(car2, 4);
  ...
  CarTransSectInner(car0, sec4, 4);
  --CarTransSectInner(car0, sec2, 2);
  --CarTransSectInner(car0, sec3, 3);

  CarTransSectInner(car1, sec0, 0);
  CarTransSectInner(car1, sec1, 1);
  CarTransSectInner(car1, sec2, 2);
  CarTransSectInner(car1, sec3, 3);
  CarTransSectInner(car1, sec4, 4);
  
  CarTransSectInner(car2, sec0, 0);
  CarTransSectInner(car2, sec1, 1);
  CarTransSectInner(car2, sec2, 2);
  CarTransSectInner(car2, sec3, 3);
  CarTransSectInner(car2, sec4, 4);

  -- Transition representing junction entering
  CarTransSectJunc2(car0, sec0, 0);
  CarTransSectJunc2(car1, sec0, 0);
  CarTransSectJunc2(car2, sec0, 0);

  CarTransSectJunc1(car0, sec1, 1);
  CarTransSectJunc1(car1, sec1, 1);
  CarTransSectJunc1(car2, sec1, 1);

  CarTransSectJunc1(car0, sec2, 2);
  CarTransSectJunc1(car1, sec2, 2);
  CarTransSectJunc1(car2, sec2, 2);

  CarTransSectJunc1(car0, sec3, 3);
  CarTransSectJunc1(car1, sec3, 3);
  CarTransSectJunc1(car2, sec3, 3);

  CarTransSectJunc0(car0, sec4, 4);
  CarTransSectJunc0(car1, sec4, 4);
  CarTransSectJunc0(car2, sec4, 4);
  -- NO NEED TO ADD THAT FOR SINK (?)
  -- TODO: CHECK!!!

  BehindDecl(car0, car1, was_behind_car0_car1, behind_car0_car1)
  BehindDecl(car0, car2, was_behind_car0_car2, behind_car0_car2)
  BehindDecl(car1, car0, was_behind_car1_car0, behind_car1_car0)
  BehindDecl(car1, car2, was_behind_car1_car2, behind_car1_car2)
  BehindDecl(car2, car0, was_behind_car2_car0, behind_car2_car0)
  BehindDecl(car2, car1, was_behind_car2_car1, behind_car2_car1)
...
#define bound_counter_upper_bound
  ...
  LTLSPEC ! (behind_sec(car0, car1) & behind_sec(car1, car2) & F (behind_sec(car2, car1) & behind_sec(car1, car0)));
  LTLSPEC ! (sec1.outgoing_connection_0 = 4 & sec2.outgoing_connection_0 = 4 & sec3.outgoing_connection_0 = 4 &behind_sec(car0, car1) & behind_sec(car1, car2) & F (behind_sec(car2, car1) & behind_sec(car1, car0)));
