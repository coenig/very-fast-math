...
@{BORDERLEFT}@******.defaultValue[-100]         -- Left...
@{BORDERTOP}@******.defaultValue[-100]          -- Top...
@{BORDERRIGHT}@******.defaultValue[100]         -- Right...
@{BORDERBOTTOM}@******.defaultValue[100]        -- Bottom border of the coordinate system the straight roads can be placed on
@{COORDGRANULARITY}@******.defaultValue[2]      -- Only every n-th coordinate in x and y direction can be used to place connection points on
