...
-- @{INIT ego.laterally_overlapping_with_veh_[i] & veh___6[i]9___.rel_pos > 0;}@.if[@{[i] < 5 && [i] < 2 * NONEGOS / 3}@.eval]
INIT -- ego.laterally_overlapping_with_veh_[i] & 
...
INIT env.veh___6[i]9___.abs_pos = @{[i]}@.eval[0] * (env.veh_length + 1) + 20;
