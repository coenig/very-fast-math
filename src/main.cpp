...
int main(int argc, char* argv[])
{
   ...
   //std::shared_ptr<CarPars> ego = std::make_shared<CarPars>(0, 5, 13, HighwayImage::EGO_MOCK_ID);
   //std::map<int, std::pair<float, float>> future_positions_of_others1{};
   //CarParsVec others1{};
   //section1e.setEgo(ego);
   //section1e.setOthers(others1);
   //section1e.setFuturePositionsOfOthers(future_positions_of_others1);
   ...
   //r1->setOriginPoint({ 0, 0 });
   //r1->setAngle(0);
   //r2->setOriginPoint({ 62, 2 });
   //r2->setAngle(3.1415 / 3);
   //r3->setOriginPoint({ 87, 18 });
   //r3->setAngle(2 * 3.1415 / 3);
   //r4->setOriginPoint({ 50, 31.5 });
   //r4->setAngle(3.1415);
   //r5->setOriginPoint({ -11, 29.5 });
   //r5->setAngle(4 * 3.1415 / 3);
   //r6->setOriginPoint({ -37, 13.5 });
   //r6->setAngle(5 * 3.1415 / 3);
   //r7->setOriginPoint({ 130, 12.5 });
   //r7->setAngle(0);
   //r8->setOriginPoint({ 180, 19 });
   //r8->setAngle(-3.1415);
   //r1->addSuccessor(r2);
   //r2->addSuccessor(r3);
   //r3->addSuccessor(r4);
   ...
   section1.addLaneSegment(segment11);
   section1e.addLaneSegment(segment11);
   std::shared_ptr<CarPars> ego = std::make_shared<CarPars>(0, 10, 13, HighwayImage::EGO_MOCK_ID);
   std::map<int, std::pair<float, float>> future_positions_of_others1{};
   CarParsVec others1{};
   section1e.setEgo(ego);
   section1e.setOthers(others1);
