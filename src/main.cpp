...
int main(int argc, char* argv[])
{
   ...
   //r1->setOriginPoint({ 0, 6 });
   //r1->setAngle(0);
   //r2->setMyRoad(section2);
   //r2->setOriginPoint({ 75, 5 * vfm::LANE_WIDTH });
   //r2->setAngle(3.1415 / 2.1);
   //r3->setMyRoad(section3);
   //r3->setOriginPoint({ r3->getMyRoad().getLength() + 85 + vfm::LANE_WIDTH, 6 });
   //r3->setAngle(-3.1415);
   //r4->setMyRoad(section4);
   //r4->setOriginPoint({ 65, -2.5 * vfm::LANE_WIDTH });
   //r4->setAngle(-3.1415 / 1.9);
   //r1->addSuccessor(r2);
   //r3->addSuccessor(r2);
   //r1->addSuccessor(r4);
   //r3->addSuccessor(r4);
   //image2.paintRoadGraph(r1, { 500, 60 }, 0, {}, true, 60, 60);
   ...
   r7->addSuccessor(r2);
   r1->addSuccessor(r6);
   image2.paintRoadGraph(r1, { 500, 60 }, 0, {}, true, 60, 20);
