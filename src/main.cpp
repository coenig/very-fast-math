...
int main(int argc, char* argv[])
{
   ...
   //std::shared_ptr<CarPars> egoa = std::make_shared<CarPars>(2, 45, 13, HighwayImage::EGO_MOCK_ID);
   ...
   image3.paintRoadGraph(r1, { 500, 120 });
