...
// -----------------------------------------------------MC MODE-----------------------------------------------------------
// The mc_mode flag has been set to true. This simplification abandons AND adds functions wrt. the regular simplification:
//   - (ABANDON) Constants will be preserved, i.e., not included in simplification of constant subtrees.
//   - (ABANDON) Rule abandoned for '!': !(!(a)) ==> boolify(a) $-1.
//   - (ABANDON) Rule abandoned for '!=': a != b ==> boolify(a) [[b: 'is_constant_and_evaluates_to_false', a: 'contains_no_meta']] $-1.
//   - (ABANDON) Rule abandoned for '==': a == b ==> !(a) [[b: 'is_constant_and_evaluates_to_false', a: 'contains_no_meta']] $-1.
//   - (ABANDON) Rule abandoned for '==': a == b ==> !(b) [[a: 'is_constant_and_evaluates_to_false', b: 'contains_no_meta']] $-1.
//   - (ABANDON) Rule abandoned for 'a_': ~(a, b) ==> ~(a - b, 0) [[~(a, b): 'is_comparator_or_equality_operation', b: 'is_constant_and_evaluates_to_true']] $-1.
//   - (ABANDON) Rule abandoned for 'a_': ~(a, b) ==> ~(a - b, 0) [[~(a, b): 'is_comparator_or_equality_operation', b: 'is_not_constant']] $-1.
//   - (ADD) Additional rule for '!': !(!(a)) ==> a $10.
//   - (ADD) Additional rule for ';': a ; b ==> a [[b: 'has_no_sideeffects']] $10.
//   - (ADD) Additional rule for ';': a ; b ==> b [[a: 'has_no_sideeffects']] $10.
//   - (ADD) Additional rule for 'ifelse': ifelse(a, b, c) ==> if(!(a), c) [[b: 'has_no_sideeffects']] $10.
//   - (ADD) Additional rule for 'ifelse': ifelse(a, b, c) ==> if(a, b) [[c: 'has_no_sideeffects']] $10.
// -----------------------------------------------------------------------------------------------------------------------

// Creation time: Mon May  4 10:47:09 2026
...
// Autogenerated function for meta rule:
// !(boolify(a)) ==> !(a) $10
inline bool apply__not_51(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "!") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
...
// Abandoned rule for '_notequal_54'.

// Autogenerated function for meta rule:
// a != b ==> boolify(b) [[a: 'is_constant_and_evaluates_to_false', b: 'contains_no_meta']] $10
inline bool apply__notequal_55(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "!=") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply__modulo_56(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "%") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply__and_71(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "&&") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply__mult_79(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (formula_0_1_0->isStructurallyEqual(formula_1_0) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_mult(formula_0_0, _pow(formula_0_1_0, _plus(formula_0_1_1, formula_1_1))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// a * b ** o_(c, 1) * d ** o_(e, 1) ==> a * b ** (c + ln(d) / ln(b) * e) [[b: 'is_constant_and_evaluates_to_true', b == d: 'is_constant_and_evaluates_to_false', ln(d) / ln(b): 'is_constant_integer', d / b == d: 'is_constant_and_evaluates_to_false', ln(b) / ln(d) == b: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
...
// Autogenerated function for meta rule:
// a * b ** o_(c, 1) * d ** o_(e, 1) ==> a * d ** (ln(b) / ln(d) * c + e) [[d: 'is_constant_and_evaluates_to_true', b == d: 'is_constant_and_evaluates_to_false', ln(b) / ln(d): 'is_constant_integer', b / d == b: 'is_constant_and_evaluates_to_false', ln(d) / ln(b) == d: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
...
// Autogenerated function for meta rule:
// a ** o_(b, 1) * c * a ** o_(d, 1) ==> c * a ** (b + d) {{'has_no_sideeffects'}} $10
inline bool apply__mult_83(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (formula_0_0_0->isStructurallyEqual(formula_1_0) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_mult(formula_0_1, _pow(formula_0_0_0, _plus(formula_0_0_1, formula_1_1))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// a ** o_(b, 1) * c * d ** o_(e, 1) ==> c * a ** (b + ln(d) / ln(a) * e) [[a: 'is_constant_and_evaluates_to_true', a == d: 'is_constant_and_evaluates_to_false', ln(d) / ln(a): 'is_constant_integer', d / a == d: 'is_constant_and_evaluates_to_false', ln(a) / ln(d) == a: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
inline bool apply__mult_84(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_0_0_0) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_0_0, formula_1_0)) && MetaRule::is_constant_integer(_div_plain(_ln_plain(formula_1_0), _ln_plain(formula_0_0_0))) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_0, formula_0_0_0), formula_1_0->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(_ln_plain(formula_0_0_0), _ln_plain(formula_1_0)), formula_0_0_0->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_mult(formula_0_1, _pow(formula_0_0_0, _plus(formula_0_0_1, _mult(_div(_ln(formula_1_0), _ln(formula_0_0_0->copy())), formula_1_1)))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// a ** o_(b, 1) * c * d ** o_(e, 1) ==> c * d ** (ln(a) / ln(d) * b + e) [[d: 'is_constant_and_evaluates_to_true', a == d: 'is_constant_and_evaluates_to_false', ln(a) / ln(d): 'is_constant_integer', a / d == a: 'is_constant_and_evaluates_to_false', ln(d) / ln(a) == d: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
inline bool apply__mult_85(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_1_0) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_0_0, formula_1_0)) && MetaRule::is_constant_integer(_div_plain(_ln_plain(formula_0_0_0), _ln_plain(formula_1_0))) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_0_0, formula_1_0), formula_0_0_0->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(_ln_plain(formula_1_0), _ln_plain(formula_0_0_0)), formula_1_0->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_mult(formula_0_1, _pow(formula_1_0, _plus(_mult(_div(_ln(formula_0_0_0), _ln(formula_1_0->copy())), formula_0_0_1), formula_1_1))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// a ** o_(b, 1) * o_(c, 1) * d ** o_(e, 1) ==> c * a ** (b + ln(d) / ln(a) * e) [[a: 'is_constant_and_evaluates_to_true', a == d: 'is_constant_and_evaluates_to_false', ln(d) / ln(a): 'is_constant_integer', d / a == d: 'is_constant_and_evaluates_to_false', ln(a) / ln(d) == a: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
...
// Autogenerated function for meta rule:
// a ** o_(b, 1) * o_(c, 1) * d ** o_(e, 1) ==> c * d ** (ln(a) / ln(d) * b + e) [[d: 'is_constant_and_evaluates_to_true', a == d: 'is_constant_and_evaluates_to_false', ln(a) / ln(d): 'is_constant_integer', d / a == d: 'is_constant_and_evaluates_to_false', ln(a) / ln(d) == a: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
...
// Autogenerated function for meta rule:
// o_(a, 1) * b ** o_(c, 1) * d ** o_(e, 1) ==> a * b ** (c + ln(d) / ln(b) * e) [[b: 'is_constant_and_evaluates_to_true', b == d: 'is_constant_and_evaluates_to_false', ln(d) / ln(b): 'is_constant_integer', d / b == d: 'is_constant_and_evaluates_to_false', ln(b) / ln(d) == b: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
...
// Autogenerated function for meta rule:
// o_(a, 1) * b ** o_(c, 1) * d ** o_(e, 1) ==> a * d ** (ln(b) / ln(d) * c + e) [[d: 'is_constant_and_evaluates_to_true', b == d: 'is_constant_and_evaluates_to_false', ln(b) / ln(d): 'is_constant_integer', d / b == d: 'is_constant_and_evaluates_to_false', ln(b) / ln(d) == b: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
inline bool apply__mult_91(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "*") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
// Autogenerated function for meta rule:
// a ** 1 ==> a $10
inline bool apply__pow_93(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "**") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply__plus_101(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (formula_0_0_0->isStructurallyEqual(formula_1_0) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_1, _mult(formula_0_0_0, _plus(formula_0_0_1, formula_1_1))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// a * o_(b, 1) + c + d * o_(e, 1) ==> c + a * (b + d / a * e) [[a: 'is_constant_and_evaluates_to_true', a == d: 'is_constant_and_evaluates_to_false', d / a: 'is_constant_integer', d / a == d: 'is_constant_and_evaluates_to_false', a / d == a: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
inline bool apply__plus_102(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_0_0_0) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_0_0, formula_1_0)) && MetaRule::is_constant_integer(_div_plain(formula_1_0, formula_0_0_0)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_0, formula_0_0_0), formula_1_0->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_0_0, formula_1_0), formula_0_0_0->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_1, _mult(formula_0_0_0, _plus(formula_0_0_1, _mult(_div(formula_1_0, formula_0_0_0->copy()), formula_1_1)))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// a * o_(b, 1) + c + d * o_(e, 1) ==> c + d * (a / d * b + e) [[d: 'is_constant_and_evaluates_to_true', a == d: 'is_constant_and_evaluates_to_false', a / d: 'is_constant_integer', a / d == a: 'is_constant_and_evaluates_to_false', d / a == d: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
inline bool apply__plus_103(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_1_0) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_0_0, formula_1_0)) && MetaRule::is_constant_integer(_div_plain(formula_0_0_0, formula_1_0)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_0_0, formula_1_0), formula_0_0_0->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_0, formula_0_0_0), formula_1_0->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_1, _mult(formula_1_0, _plus(_mult(_div(formula_0_0_0, formula_1_0->copy()), formula_0_0_1), formula_1_1))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// a * o_(b, 1) + c + o_(d, 1) * a ==> c + a * (b + d) {{'has_no_sideeffects'}} $10
inline bool apply__plus_104(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (formula_0_0_0->isStructurallyEqual(formula_1_1) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_1, _mult(formula_0_0_0, _plus(formula_0_0_1, formula_1_0))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// a * o_(b, 1) + c + o_(d, 1) * e ==> c + a * (b + e / a * d) [[a: 'is_constant_and_evaluates_to_true', a == e: 'is_constant_and_evaluates_to_false', e / a: 'is_constant_integer', e / a == e: 'is_constant_and_evaluates_to_false', a / e == a: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
inline bool apply__plus_105(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_0_0_0) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_0_0, formula_1_1)) && MetaRule::is_constant_integer(_div_plain(formula_1_1, formula_0_0_0)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_1, formula_0_0_0), formula_1_1->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_0_0, formula_1_1), formula_0_0_0->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_1, _mult(formula_0_0_0, _plus(formula_0_0_1, _mult(_div(formula_1_1, formula_0_0_0->copy()), formula_1_0)))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// a * o_(b, 1) + c + o_(d, 1) * e ==> c + e * (a / e * b + d) [[e: 'is_constant_and_evaluates_to_true', a == e: 'is_constant_and_evaluates_to_false', a / e: 'is_constant_integer', a / e == a: 'is_constant_and_evaluates_to_false', e / a == e: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
inline bool apply__plus_106(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_1_1) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_0_0, formula_1_1)) && MetaRule::is_constant_integer(_div_plain(formula_0_0_0, formula_1_1)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_0_0, formula_1_1), formula_0_0_0->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_1, formula_0_0_0), formula_1_1->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_1, _mult(formula_1_1, _plus(_mult(_div(formula_0_0_0, formula_1_1->copy()), formula_0_0_1), formula_1_0))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// a * o_(b, 1) + o_(c, 0) + d * o_(e, 1) ==> c + a * (b + d / a * e) [[a: 'is_constant_and_evaluates_to_true', a == d: 'is_constant_and_evaluates_to_false', d / a: 'is_constant_integer', d / a == d: 'is_constant_and_evaluates_to_false', a / d == a: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
...
// Autogenerated function for meta rule:
// a * o_(b, 1) + o_(c, 0) + d * o_(e, 1) ==> c + d * (a / d * b + e) [[d: 'is_constant_and_evaluates_to_true', a == d: 'is_constant_and_evaluates_to_false', a / d: 'is_constant_integer', d / a == d: 'is_constant_and_evaluates_to_false', a / d == a: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
...
// Autogenerated function for meta rule:
// a * o_(b, 1) + o_(c, 0) + o_(d, 1) * e ==> c + a * (b + e / a * d) [[a: 'is_constant_and_evaluates_to_true', a == e: 'is_constant_and_evaluates_to_false', e / a: 'is_constant_integer', e / a == e: 'is_constant_and_evaluates_to_false', a / e == a: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
...
// Autogenerated function for meta rule:
// a * o_(b, 1) + o_(c, 0) + o_(d, 1) * e ==> c + e * (a / e * b + d) [[e: 'is_constant_and_evaluates_to_true', a == e: 'is_constant_and_evaluates_to_false', a / e: 'is_constant_integer', e / a == e: 'is_constant_and_evaluates_to_false', a / e == a: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
...
inline bool apply__plus_116(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (formula_0_1_0->isStructurallyEqual(formula_1_0) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_0_1_0, _plus(formula_0_1_1, formula_1_1))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// a + b * o_(c, 1) + d * o_(e, 1) ==> a + b * (c + d / b * e) [[b: 'is_constant_and_evaluates_to_true', b == d: 'is_constant_and_evaluates_to_false', d / b: 'is_constant_integer', d / b == d: 'is_constant_and_evaluates_to_false', b / d == b: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
inline bool apply__plus_117(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_0_1_0) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_0, formula_1_0)) && MetaRule::is_constant_integer(_div_plain(formula_1_0, formula_0_1_0)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_0, formula_0_1_0), formula_1_0->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_0, formula_1_0), formula_0_1_0->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_0_1_0, _plus(formula_0_1_1, _mult(_div(formula_1_0, formula_0_1_0->copy()), formula_1_1)))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// a + b * o_(c, 1) + d * o_(e, 1) ==> a + d * (b / d * c + e) [[d: 'is_constant_and_evaluates_to_true', b == d: 'is_constant_and_evaluates_to_false', b / d: 'is_constant_integer', b / d == b: 'is_constant_and_evaluates_to_false', d / b == d: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
inline bool apply__plus_118(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_1_0) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_0, formula_1_0)) && MetaRule::is_constant_integer(_div_plain(formula_0_1_0, formula_1_0)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_0, formula_1_0), formula_0_1_0->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_0, formula_0_1_0), formula_1_0->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_1_0, _plus(_mult(_div(formula_0_1_0, formula_1_0->copy()), formula_0_1_1), formula_1_1))));
      return true;
   }
   return false;
}
...
inline bool apply__plus_119(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (formula_0_1_0->isStructurallyEqual(formula_1_1) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_0_1_0, _plus(formula_0_1_1, formula_1_0))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// a + b * o_(c, 1) + o_(d, 1) * e ==> a + b * (c + e / b * d) [[b: 'is_constant_and_evaluates_to_true', b == e: 'is_constant_and_evaluates_to_false', e / b: 'is_constant_integer', e / b == e: 'is_constant_and_evaluates_to_false', b / e == b: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
inline bool apply__plus_120(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_0_1_0) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_0, formula_1_1)) && MetaRule::is_constant_integer(_div_plain(formula_1_1, formula_0_1_0)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_1, formula_0_1_0), formula_1_1->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_0, formula_1_1), formula_0_1_0->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_0_1_0, _plus(formula_0_1_1, _mult(_div(formula_1_1, formula_0_1_0->copy()), formula_1_0)))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// a + b * o_(c, 1) + o_(d, 1) * e ==> a + e * (b / e * c + d) [[e: 'is_constant_and_evaluates_to_true', b == e: 'is_constant_and_evaluates_to_false', b / e: 'is_constant_integer', b / e == b: 'is_constant_and_evaluates_to_false', e / b == e: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
inline bool apply__plus_121(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_1_1) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_0, formula_1_1)) && MetaRule::is_constant_integer(_div_plain(formula_0_1_0, formula_1_1)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_0, formula_1_1), formula_0_1_0->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_1, formula_0_1_0), formula_1_1->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_1_1, _plus(_mult(_div(formula_0_1_0, formula_1_1->copy()), formula_0_1_1), formula_1_0))));
      return true;
   }
   return false;
}
...
inline bool apply__plus_122(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (formula_0_1_1->isStructurallyEqual(formula_1_0) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_0_1_1, _plus(formula_0_1_0, formula_1_1))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// a + o_(b, 1) * c + d * o_(e, 1) ==> a + c * (b + d / c * e) [[c: 'is_constant_and_evaluates_to_true', c == d: 'is_constant_and_evaluates_to_false', d / c: 'is_constant_integer', d / c == d: 'is_constant_and_evaluates_to_false', c / d == c: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
inline bool apply__plus_123(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_0_1_1) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_1, formula_1_0)) && MetaRule::is_constant_integer(_div_plain(formula_1_0, formula_0_1_1)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_0, formula_0_1_1), formula_1_0->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_1, formula_1_0), formula_0_1_1->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_0_1_1, _plus(formula_0_1_0, _mult(_div(formula_1_0, formula_0_1_1->copy()), formula_1_1)))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// a + o_(b, 1) * c + d * o_(e, 1) ==> a + d * (c / d * b + e) [[d: 'is_constant_and_evaluates_to_true', c == d: 'is_constant_and_evaluates_to_false', c / d: 'is_constant_integer', c / d == c: 'is_constant_and_evaluates_to_false', d / c == d: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
inline bool apply__plus_124(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_1_0) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_1, formula_1_0)) && MetaRule::is_constant_integer(_div_plain(formula_0_1_1, formula_1_0)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_1, formula_1_0), formula_0_1_1->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_0, formula_0_1_1), formula_1_0->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_1_0, _plus(_mult(_div(formula_0_1_1, formula_1_0->copy()), formula_0_1_0), formula_1_1))));
      return true;
   }
   return false;
}
...
inline bool apply__plus_125(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (formula_0_1_1->isStructurallyEqual(formula_1_1) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_0_1_1, _plus(formula_0_1_0, formula_1_0))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// a + o_(b, 1) * c + o_(d, 1) * e ==> a + c * (b + e / c * d) [[c: 'is_constant_and_evaluates_to_true', c == e: 'is_constant_and_evaluates_to_false', e / c: 'is_constant_integer', e / c == e: 'is_constant_and_evaluates_to_false', c / e == c: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
inline bool apply__plus_126(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_0_1_1) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_1, formula_1_1)) && MetaRule::is_constant_integer(_div_plain(formula_1_1, formula_0_1_1)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_1, formula_0_1_1), formula_1_1->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_1, formula_1_1), formula_0_1_1->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_0_1_1, _plus(formula_0_1_0, _mult(_div(formula_1_1, formula_0_1_1->copy()), formula_1_0)))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// a + o_(b, 1) * c + o_(d, 1) * e ==> a + e * (c / e * b + d) [[e: 'is_constant_and_evaluates_to_true', c == e: 'is_constant_and_evaluates_to_false', c / e: 'is_constant_integer', c / e == c: 'is_constant_and_evaluates_to_false', e / c == e: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
inline bool apply__plus_127(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_1_1) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_1, formula_1_1)) && MetaRule::is_constant_integer(_div_plain(formula_0_1_1, formula_1_1)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_1, formula_1_1), formula_0_1_1->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_1, formula_0_1_1), formula_1_1->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_1_1, _plus(_mult(_div(formula_0_1_1, formula_1_1->copy()), formula_0_1_0), formula_1_0))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// o_(a, 0) + b * o_(c, 1) + d * o_(e, 1) ==> a + b * (c + d / b * e) [[b: 'is_constant_and_evaluates_to_true', b == d: 'is_constant_and_evaluates_to_false', d / b: 'is_constant_integer', d / b == d: 'is_constant_and_evaluates_to_false', b / d == b: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
...
// Autogenerated function for meta rule:
// o_(a, 0) + b * o_(c, 1) + d * o_(e, 1) ==> a + d * (b / d * c + e) [[d: 'is_constant_and_evaluates_to_true', b == d: 'is_constant_and_evaluates_to_false', b / d: 'is_constant_integer', d / b == d: 'is_constant_and_evaluates_to_false', b / d == b: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
...
// Autogenerated function for meta rule:
// o_(a, 0) + b * o_(c, 1) + o_(d, 1) * e ==> a + b * (c + e / b * d) [[b: 'is_constant_and_evaluates_to_true', b == e: 'is_constant_and_evaluates_to_false', e / b: 'is_constant_integer', e / b == e: 'is_constant_and_evaluates_to_false', b / e == b: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
...
// Autogenerated function for meta rule:
// o_(a, 0) + b * o_(c, 1) + o_(d, 1) * e ==> a + e * (b / e * c + d) [[e: 'is_constant_and_evaluates_to_true', b == e: 'is_constant_and_evaluates_to_false', b / e: 'is_constant_integer', e / b == e: 'is_constant_and_evaluates_to_false', b / e == b: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
...
// Autogenerated function for meta rule:
// o_(a, 0) + o_(b, 1) * c + d * o_(e, 1) ==> a + c * (b + d / c * e) [[c: 'is_constant_and_evaluates_to_true', c == d: 'is_constant_and_evaluates_to_false', d / c: 'is_constant_integer', d / c == d: 'is_constant_and_evaluates_to_false', c / d == c: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
...
// Autogenerated function for meta rule:
// o_(a, 0) + o_(b, 1) * c + d * o_(e, 1) ==> a + d * (c / d * b + e) [[d: 'is_constant_and_evaluates_to_true', c == d: 'is_constant_and_evaluates_to_false', c / d: 'is_constant_integer', d / c == d: 'is_constant_and_evaluates_to_false', c / d == c: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
...
// Autogenerated function for meta rule:
// o_(a, 0) + o_(b, 1) * c + o_(d, 1) * e ==> a + c * (b + e / c * d) [[c: 'is_constant_and_evaluates_to_true', c == e: 'is_constant_and_evaluates_to_false', e / c: 'is_constant_integer', e / c == e: 'is_constant_and_evaluates_to_false', c / e == c: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
...
// Autogenerated function for meta rule:
// o_(a, 0) + o_(b, 1) * c + o_(d, 1) * e ==> a + e * (c / e * b + d) [[e: 'is_constant_and_evaluates_to_true', c == e: 'is_constant_and_evaluates_to_false', c / e: 'is_constant_integer', e / c == e: 'is_constant_and_evaluates_to_false', c / e == c: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
...
// Autogenerated function for meta rule:
// o_(a, 1) * b + c + b * o_(d, 1) ==> c + b * (a + d) {{'has_no_sideeffects'}} $10
inline bool apply__plus_140(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (formula_0_0_1->isStructurallyEqual(formula_1_0) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_1, _mult(formula_0_0_1, _plus(formula_0_0_0, formula_1_1))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// o_(a, 1) * b + c + d * o_(e, 1) ==> c + b * (a + d / b * e) [[b: 'is_constant_and_evaluates_to_true', b == d: 'is_constant_and_evaluates_to_false', d / b: 'is_constant_integer', d / b == d: 'is_constant_and_evaluates_to_false', b / d == b: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
inline bool apply__plus_141(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_0_0_1) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_0_1, formula_1_0)) && MetaRule::is_constant_integer(_div_plain(formula_1_0, formula_0_0_1)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_0, formula_0_0_1), formula_1_0->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_0_1, formula_1_0), formula_0_0_1->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_1, _mult(formula_0_0_1, _plus(formula_0_0_0, _mult(_div(formula_1_0, formula_0_0_1->copy()), formula_1_1)))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// o_(a, 1) * b + c + d * o_(e, 1) ==> c + d * (b / d * a + e) [[d: 'is_constant_and_evaluates_to_true', b == d: 'is_constant_and_evaluates_to_false', b / d: 'is_constant_integer', b / d == b: 'is_constant_and_evaluates_to_false', d / b == d: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
inline bool apply__plus_142(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_1_0) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_0_1, formula_1_0)) && MetaRule::is_constant_integer(_div_plain(formula_0_0_1, formula_1_0)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_0_1, formula_1_0), formula_0_0_1->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_0, formula_0_0_1), formula_1_0->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_1, _mult(formula_1_0, _plus(_mult(_div(formula_0_0_1, formula_1_0->copy()), formula_0_0_0), formula_1_1))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// o_(a, 1) * b + c + o_(d, 1) * b ==> c + b * (a + d) {{'has_no_sideeffects'}} $10
inline bool apply__plus_143(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (formula_0_0_1->isStructurallyEqual(formula_1_1) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_1, _mult(formula_0_0_1, _plus(formula_0_0_0, formula_1_0))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// o_(a, 1) * b + c + o_(d, 1) * e ==> c + b * (a + e / b * d) [[b: 'is_constant_and_evaluates_to_true', b == e: 'is_constant_and_evaluates_to_false', e / b: 'is_constant_integer', e / b == e: 'is_constant_and_evaluates_to_false', b / e == b: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
inline bool apply__plus_144(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_0_0_1) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_0_1, formula_1_1)) && MetaRule::is_constant_integer(_div_plain(formula_1_1, formula_0_0_1)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_1, formula_0_0_1), formula_1_1->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_0_1, formula_1_1), formula_0_0_1->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_1, _mult(formula_0_0_1, _plus(formula_0_0_0, _mult(_div(formula_1_1, formula_0_0_1->copy()), formula_1_0)))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// o_(a, 1) * b + c + o_(d, 1) * e ==> c + e * (b / e * a + d) [[e: 'is_constant_and_evaluates_to_true', b == e: 'is_constant_and_evaluates_to_false', b / e: 'is_constant_integer', b / e == b: 'is_constant_and_evaluates_to_false', e / b == e: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
inline bool apply__plus_145(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_1_1) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_0_1, formula_1_1)) && MetaRule::is_constant_integer(_div_plain(formula_0_0_1, formula_1_1)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_0_1, formula_1_1), formula_0_0_1->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_1, formula_0_0_1), formula_1_1->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_1, _mult(formula_1_1, _plus(_mult(_div(formula_0_0_1, formula_1_1->copy()), formula_0_0_0), formula_1_0))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// o_(a, 1) * b + o_(c, 0) + d * o_(e, 1) ==> c + b * (a + d / b * e) [[b: 'is_constant_and_evaluates_to_true', b == d: 'is_constant_and_evaluates_to_false', d / b: 'is_constant_integer', d / b == d: 'is_constant_and_evaluates_to_false', b / d == b: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
...
// Autogenerated function for meta rule:
// o_(a, 1) * b + o_(c, 0) + d * o_(e, 1) ==> c + d * (b / d * a + e) [[d: 'is_constant_and_evaluates_to_true', b == d: 'is_constant_and_evaluates_to_false', b / d: 'is_constant_integer', d / b == d: 'is_constant_and_evaluates_to_false', b / d == b: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
...
// Autogenerated function for meta rule:
// o_(a, 1) * b + o_(c, 0) + o_(d, 1) * e ==> c + b * (a + e / b * d) [[b: 'is_constant_and_evaluates_to_true', b == e: 'is_constant_and_evaluates_to_false', e / b: 'is_constant_integer', e / b == e: 'is_constant_and_evaluates_to_false', b / e == b: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
...
// Autogenerated function for meta rule:
// o_(a, 1) * b + o_(c, 0) + o_(d, 1) * e ==> c + e * (b / e * a + d) [[e: 'is_constant_and_evaluates_to_true', b == e: 'is_constant_and_evaluates_to_false', b / e: 'is_constant_integer', e / b == e: 'is_constant_and_evaluates_to_false', b / e == b: 'is_constant_and_evaluates_to_false']] {{'has_no_sideeffects'}} $10
inline bool apply__plus_151(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "+") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply__minus_154(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_0_0_0) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_0_0, formula_1_0)) && MetaRule::is_constant_integer(_div_plain(formula_1_0, formula_0_0_0)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_0, formula_0_0_0), formula_1_0->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_0_0, formula_1_0), formula_0_0_0->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_1, _mult(formula_0_0_0, _plus(formula_0_0_1, _neg(_mult(_div(formula_1_0, formula_0_0_0->copy()), formula_1_1))))));
      return true;
   }
   return false;
}
...
inline bool apply__minus_155(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_1_0) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_0_0, formula_1_0)) && MetaRule::is_constant_integer(_div_plain(formula_0_0_0, formula_1_0)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_0, formula_0_0_0), formula_1_0->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_0_0, formula_1_0), formula_0_0_0->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_1, _mult(formula_1_0, _plus(_mult(_div(formula_0_0_0, formula_1_0->copy()), formula_0_0_1), _neg(formula_1_1)))));
      return true;
   }
   return false;
}
...
inline bool apply__minus_157(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_0_0_0) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_0_0, formula_1_1)) && MetaRule::is_constant_integer(_div_plain(formula_1_1, formula_0_0_0)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_1, formula_0_0_0), formula_1_1->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_0_0, formula_1_1), formula_0_0_0->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_1, _mult(formula_0_0_0, _plus(formula_0_0_1, _neg(_mult(_div(formula_1_1, formula_0_0_0->copy()), formula_1_0))))));
      return true;
   }
   return false;
}
...
inline bool apply__minus_158(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_1_1) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_0_0, formula_1_1)) && MetaRule::is_constant_integer(_div_plain(formula_0_0_0, formula_1_1)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_1, formula_0_0_0), formula_1_1->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_0_0, formula_1_1), formula_0_0_0->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_1, _mult(formula_1_1, _plus(_mult(_div(formula_0_0_0, formula_1_1->copy()), formula_0_0_1), _neg(formula_1_0)))));
      return true;
   }
   return false;
}
...
inline bool apply__minus_160(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_0_1_0) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_0, formula_1_0)) && MetaRule::is_constant_integer(_div_plain(formula_1_0, formula_0_1_0)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_0, formula_0_1_0), formula_1_0->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_0, formula_1_0), formula_0_1_0->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_0_1_0, _plus(_neg(formula_0_1_1), _neg(_mult(_div(formula_1_0, formula_0_1_0->copy()), formula_1_1))))));
      return true;
   }
   return false;
}
...
inline bool apply__minus_161(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_1_0) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_0, formula_1_0)) && MetaRule::is_constant_integer(_div_plain(formula_0_1_0, formula_1_0)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_0, formula_1_0), formula_0_1_0->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_0, formula_0_1_0), formula_1_0->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_1_0, _plus(_neg(_mult(_div(formula_0_1_0, formula_1_0->copy()), formula_0_1_1)), _neg(formula_1_1)))));
      return true;
   }
   return false;
}
...
inline bool apply__minus_163(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_0_1_0) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_0, formula_1_1)) && MetaRule::is_constant_integer(_div_plain(formula_1_1, formula_0_1_0)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_1, formula_0_1_0), formula_1_1->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_0, formula_1_1), formula_0_1_0->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_0_1_0, _plus(_neg(formula_0_1_1), _neg(_mult(_div(formula_1_1, formula_0_1_0->copy()), formula_1_0))))));
      return true;
   }
   return false;
}
...
inline bool apply__minus_164(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_1_1) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_0, formula_1_1)) && MetaRule::is_constant_integer(_div_plain(formula_0_1_0, formula_1_1)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_0, formula_1_1), formula_0_1_0->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_1, formula_0_1_0), formula_1_1->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_1_1, _plus(_neg(_mult(_div(formula_0_1_0, formula_1_1->copy()), formula_0_1_1)), _neg(formula_1_0)))));
      return true;
   }
   return false;
}
...
inline bool apply__minus_166(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_0_1_1) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_1, formula_1_0)) && MetaRule::is_constant_integer(_div_plain(formula_1_0, formula_0_1_1)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_0, formula_0_1_1), formula_1_0->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_1, formula_1_0), formula_0_1_1->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_0_1_1, _plus(_neg(formula_0_1_0), _neg(_mult(_div(formula_1_0, formula_0_1_1->copy()), formula_1_1))))));
      return true;
   }
   return false;
}
...
inline bool apply__minus_167(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_1_0) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_1, formula_1_0)) && MetaRule::is_constant_integer(_div_plain(formula_0_1_1, formula_1_0)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_1, formula_1_0), formula_0_1_1->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_0, formula_0_1_1), formula_1_0->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_1_0, _plus(_neg(_mult(_div(formula_0_1_1, formula_1_0->copy()), formula_0_1_0)), _neg(formula_1_1)))));
      return true;
   }
   return false;
}
...
inline bool apply__minus_169(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_0_1_1) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_1, formula_1_1)) && MetaRule::is_constant_integer(_div_plain(formula_1_1, formula_0_1_1)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_1, formula_0_1_1), formula_1_1->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_1, formula_1_1), formula_0_1_1->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_0_1_1, _plus(_neg(formula_0_1_0), _neg(_mult(_div(formula_1_1, formula_0_1_1->copy()), formula_1_0))))));
      return true;
   }
   return false;
}
...
inline bool apply__minus_170(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_1_1) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_1, formula_1_1)) && MetaRule::is_constant_integer(_div_plain(formula_0_1_1, formula_1_1)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_1, formula_1_1), formula_0_1_1->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_1, formula_0_1_1), formula_1_1->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_1_1, _plus(_neg(_mult(_div(formula_0_1_1, formula_1_1->copy()), formula_0_1_0)), _neg(formula_1_0)))));
      return true;
   }
   return false;
}
...
inline bool apply__minus_172(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_0_1_0) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_0, formula_1_0)) && MetaRule::is_constant_integer(_div_plain(formula_1_0, formula_0_1_0)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_0, formula_0_1_0), formula_1_0->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_0, formula_1_0), formula_0_1_0->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_0_1_0, _plus(formula_0_1_1, _neg(_mult(_div(formula_1_0, formula_0_1_0->copy()), formula_1_1))))));
      return true;
   }
   return false;
}
...
inline bool apply__minus_173(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_1_0) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_0, formula_1_0)) && MetaRule::is_constant_integer(_div_plain(formula_0_1_0, formula_1_0)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_0, formula_0_1_0), formula_1_0->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_0, formula_1_0), formula_0_1_0->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_1_0, _plus(_mult(_div(formula_0_1_0, formula_1_0->copy()), formula_0_1_1), _neg(formula_1_1)))));
      return true;
   }
   return false;
}
...
inline bool apply__minus_175(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_0_1_0) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_0, formula_1_1)) && MetaRule::is_constant_integer(_div_plain(formula_1_1, formula_0_1_0)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_1, formula_0_1_0), formula_1_1->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_0, formula_1_1), formula_0_1_0->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_0_1_0, _plus(formula_0_1_1, _neg(_mult(_div(formula_1_1, formula_0_1_0->copy()), formula_1_0))))));
      return true;
   }
   return false;
}
...
inline bool apply__minus_176(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_1_1) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_0, formula_1_1)) && MetaRule::is_constant_integer(_div_plain(formula_0_1_0, formula_1_1)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_1, formula_0_1_0), formula_1_1->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_0, formula_1_1), formula_0_1_0->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_1_1, _plus(_mult(_div(formula_0_1_0, formula_1_1->copy()), formula_0_1_1), _neg(formula_1_0)))));
      return true;
   }
   return false;
}
...
inline bool apply__minus_178(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_0_1_1) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_1, formula_1_0)) && MetaRule::is_constant_integer(_div_plain(formula_1_0, formula_0_1_1)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_0, formula_0_1_1), formula_1_0->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_1, formula_1_0), formula_0_1_1->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_0_1_1, _plus(formula_0_1_0, _neg(_mult(_div(formula_1_0, formula_0_1_1->copy()), formula_1_1))))));
      return true;
   }
   return false;
}
...
inline bool apply__minus_179(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_1_0) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_1, formula_1_0)) && MetaRule::is_constant_integer(_div_plain(formula_0_1_1, formula_1_0)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_0, formula_0_1_1), formula_1_0->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_1, formula_1_0), formula_0_1_1->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_1_0, _plus(_mult(_div(formula_0_1_1, formula_1_0->copy()), formula_0_1_0), _neg(formula_1_1)))));
      return true;
   }
   return false;
}
...
inline bool apply__minus_181(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_0_1_1) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_1, formula_1_1)) && MetaRule::is_constant_integer(_div_plain(formula_1_1, formula_0_1_1)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_1, formula_0_1_1), formula_1_1->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_1, formula_1_1), formula_0_1_1->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_0_1_1, _plus(formula_0_1_0, _neg(_mult(_div(formula_1_1, formula_0_1_1->copy()), formula_1_0))))));
      return true;
   }
   return false;
}
...
inline bool apply__minus_182(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_1_1) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_1_1, formula_1_1)) && MetaRule::is_constant_integer(_div_plain(formula_0_1_1, formula_1_1)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_1, formula_0_1_1), formula_1_1->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_1_1, formula_1_1), formula_0_1_1->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_0, _mult(formula_1_1, _plus(_mult(_div(formula_0_1_1, formula_1_1->copy()), formula_0_1_0), _neg(formula_1_0)))));
      return true;
   }
   return false;
}
...
inline bool apply__minus_184(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_0_0_1) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_0_1, formula_1_0)) && MetaRule::is_constant_integer(_div_plain(formula_1_0, formula_0_0_1)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_0, formula_0_0_1), formula_1_0->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_0_1, formula_1_0), formula_0_0_1->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_1, _mult(formula_0_0_1, _plus(formula_0_0_0, _neg(_mult(_div(formula_1_0, formula_0_0_1->copy()), formula_1_1))))));
      return true;
   }
   return false;
}
...
inline bool apply__minus_185(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_1_0) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_0_1, formula_1_0)) && MetaRule::is_constant_integer(_div_plain(formula_0_0_1, formula_1_0)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_0, formula_0_0_1), formula_1_0->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_0_1, formula_1_0), formula_0_0_1->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_1, _mult(formula_1_0, _plus(_mult(_div(formula_0_0_1, formula_1_0->copy()), formula_0_0_0), _neg(formula_1_1)))));
      return true;
   }
   return false;
}
...
inline bool apply__minus_187(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_0_0_1) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_0_1, formula_1_1)) && MetaRule::is_constant_integer(_div_plain(formula_1_1, formula_0_0_1)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_1, formula_0_0_1), formula_1_1->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_0_1, formula_1_1), formula_0_0_1->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_1, _mult(formula_0_0_1, _plus(formula_0_0_0, _neg(_mult(_div(formula_1_1, formula_0_0_1->copy()), formula_1_0))))));
      return true;
   }
   return false;
}
...
inline bool apply__minus_188(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   if (MetaRule::is_constant_and_evaluates_to_true(formula_1_1) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(formula_0_0_1, formula_1_1)) && MetaRule::is_constant_integer(_div_plain(formula_0_0_1, formula_1_1)) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_1_1, formula_0_0_1), formula_1_1->copy())) && MetaRule::is_constant_and_evaluates_to_false(_eq_plain(_div_plain(formula_0_0_1, formula_1_1), formula_0_0_1->copy())) && MetaRule::has_no_sideeffects(formula)) {
      formula->replace(_plus(formula_0_1, _mult(formula_1_1, _plus(_mult(_div(formula_0_0_1, formula_1_1->copy()), formula_0_0_0), _neg(formula_1_0)))));
      return true;
   }
   return false;
}
...
// Autogenerated function for meta rule:
// a - b ==> a +  --(b) [[b: 'is_constant_and_evaluates_to_negative']] $10
inline bool apply__minus_199(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "-" || formula->getTermsJumpIntoCompounds().size() != 2) return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply__minus__minus_201(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "--") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   if (formula_0->getOptorOnCompoundLevel() != "*") {
...
// Autogenerated function for meta rule:
// a / 1 ==> a $10
inline bool apply__div_212(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "/") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply__semicolon_216(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != ";") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply__semicolon_217(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != ";") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply__semicolon_218(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != ";") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
// Autogenerated function for meta rule:
//  --(a) <  --(b) ==> a > b $10
inline bool apply__smaller_219(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "<") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
// Autogenerated function for meta rule:
// a < a ==> 0 {{'has_no_sideeffects'}} $10
inline bool apply__smaller_220(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "<") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
// Autogenerated function for meta rule:
//  --(a) <=  --(b) ==> a >= b $10
inline bool apply__smallerorequal_221(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "<=") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply__smallerorequal_222(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "<=") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply__equal_sign_223(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "=") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
// Autogenerated function for meta rule:
// a == a ==> 1 {{'has_no_sideeffects'}} $10
inline bool apply__equal_225(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "==") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
// Abandoned rule for '_equal_226'.

// Abandoned rule for '_equal_227'.

// Autogenerated function for meta rule:
//  --(a) >  --(b) ==> a < b $10
inline bool apply__greater_228(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != ">") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
// Autogenerated function for meta rule:
// a > a ==> 0 {{'has_no_sideeffects'}} $10
inline bool apply__greater_229(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != ">") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
// Autogenerated function for meta rule:
//  --(a) >=  --(b) ==> a <= b $10
inline bool apply__greaterorequal_230(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != ">=") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
// Autogenerated function for meta rule:
// a >= a ==> 1 {{'has_no_sideeffects'}} $10
inline bool apply__greaterorequal_231(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != ">=") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply__anyway_operation_232(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getTermsJumpIntoCompounds().size() != 2) return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
// Autogenerated function for meta rule:
// abs( --(a)) ==> abs(a) $10
inline bool apply_abs233(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
...
// Autogenerated function for meta rule:
// abs(abs(a)) ==> abs(a) $10
inline bool apply_abs234(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "abs") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
...
// Autogenerated function for meta rule:
// boolify(!(a)) ==> !(a) $10
inline bool apply_boolify235(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
...
inline bool apply_boolify236(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "boolify") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
...
inline bool apply_free237(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
...
// Autogenerated function for meta rule:
// id(a) ==> a $10
inline bool apply_id238(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
...
inline bool apply_if247(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "if") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply_if248(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "if") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply_if249(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "if") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
// Autogenerated function for meta rule:
// ifelse(a, b, c) ==> if(!(a), c) [[b: 'has_no_sideeffects']] $10
...
// Autogenerated function for meta rule:
// ifelse(a, b, c) ==> if(a, b) [[c: 'has_no_sideeffects']] $10
inline bool apply_ifelse255(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   ...
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
   TermPtr formula_2 = formula->getTermsJumpIntoCompounds()[2];
   if (MetaRule::has_no_sideeffects(formula_2) && MetaRule::no_check(formula)) {
...
inline bool apply_ifelse261(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "ifelse") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply_ifelse262(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "ifelse") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply_ifelse263(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "ifelse") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply_ifelse264(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "ifelse") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply_ifelse265(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "ifelse") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply_malloc266(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
...
inline bool apply_max267(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "max") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply_max268(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "max") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply_min269(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "min") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply_min270(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "min") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply_print_plain271(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
...
inline bool apply_sqrt272(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
...
// Autogenerated function for meta rule:
// trunc((a >= b)) ==> a >= b $10
inline bool apply_trunc279(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "trunc") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   if (formula_0->getOptorOnCompoundLevel() != ">=") {
...
// Autogenerated function for meta rule:
// trunc(a && b) ==> a && b $10
inline bool apply_trunc280(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "trunc") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   if (formula_0->getOptorOnCompoundLevel() != "&&") {
...
// Autogenerated function for meta rule:
// trunc(a || b) ==> a || b $10
inline bool apply_trunc281(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "trunc") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   if (formula_0->getOptorOnCompoundLevel() != "||") {
...
inline bool apply_trunc282(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "trunc") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   if (formula_0->getOptorOnCompoundLevel() != "boolify") {
...
inline bool apply_trunc283(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "trunc") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
...
inline bool apply_whilelim284(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
...
inline bool apply_whilelim285(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "whilelim") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply__or_295(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "||") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
// Autogenerated function for meta rule:
// a || b && a ==> (1 || b) && a [[a: 'is_not_constant']] {{'has_no_sideeffects'}} $10
inline bool apply__or_296(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "||") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
inline bool apply__or_297(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "||") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
// Autogenerated function for meta rule:
// a || b ==> a || boolify(b) [[b: 'is_non_boolean_constant']] $10
inline bool apply__or_298(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "||") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
// Autogenerated function for meta rule:
// a || b ==> boolify(a) || b [[a: 'is_non_boolean_constant']] $10
inline bool apply__or_299(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   // if (formula->getOptorOnCompoundLevel() != "||") return false;
   TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
   TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
   ...
   while (changed) {
      ...
      formula->getOperands()[0]->applyToMeAndMyChildrenIterative([&changed, p](const MathStructPtr m) {
         ...
         for (int i = 0; i < 1 && m->getFather(); i++) {
            if (!m->isCompoundOperator() && !m->isTermCompound() && m->consistsPurelyOfNumbers()) {
               m->replace(_val_plain(m->constEval()));
      ...
      formula->getOperands()[0]->applyToMeAndMyChildrenIterative([&changed, p](const MathStructPtr m) {
         ...
         for (int i = 0; i < 1 && m->getFather(); i++) {
            if (!m->isCompoundOperator() && !m->isTermCompound() && m->consistsPurelyOfNumbers()) {
               ...
               if (changed_this_time) break;
               changed_this_time = apply__not_51(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptor() == "!=") {
               ...
               if (changed_this_time) break;
               changed_this_time = apply__notequal_55(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptor() == "%") {
               changed_this_time = apply__modulo_56(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptor() == "&&") {
               ...
               if (changed_this_time) break;
               changed_this_time = apply__and_71(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptor() == "*") {
               ...
               if (changed_this_time) break;
               changed_this_time = apply__mult_91(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptor() == "**") {
               changed_this_time = apply__pow_92(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply__pow_93(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptor() == "+") {
               ...
               if (changed_this_time) break;
               changed_this_time = apply__plus_151(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptorOnCompoundLevel() == "-") {
               if (m->getTermsJumpIntoCompounds().size() == 2) {
                  ...
                  if (changed_this_time) break;
                  changed_this_time = apply__minus_199(m->toTermIfApplicable(), p);
                  if (changed_this_time) break;
               }
            }
            else if (m->getOptor() == "--") {
               ...
               if (changed_this_time) break;
               changed_this_time = apply__minus__minus_201(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptor() == "/") {
               ...
               if (changed_this_time) break;
               changed_this_time = apply__div_212(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptorOnCompoundLevel() == ";") {
               ...
               if (changed_this_time) break;
               changed_this_time = apply__semicolon_216(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply__semicolon_217(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply__semicolon_218(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptor() == "<") {
               changed_this_time = apply__smaller_219(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply__smaller_220(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptor() == "<=") {
               changed_this_time = apply__smallerorequal_221(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply__smallerorequal_222(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptorOnCompoundLevel() == "=") {
               changed_this_time = apply__equal_sign_223(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptor() == "==") {
               changed_this_time = apply__equal_224(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply__equal_225(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptor() == ">") {
               changed_this_time = apply__greater_228(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply__greater_229(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptor() == ">=") {
               changed_this_time = apply__greaterorequal_230(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply__greaterorequal_231(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptor() == "abs") {
               changed_this_time = apply_abs233(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply_abs234(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptorOnCompoundLevel() == "boolify") {
               changed_this_time = apply_boolify235(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply_boolify236(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptor() == "free") {
               changed_this_time = apply_free237(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptor() == "id") {
               changed_this_time = apply_id238(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
               ...
               if (changed_this_time) break;
               changed_this_time = apply_if247(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply_if248(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply_if249(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
               ...
               if (changed_this_time) break;
               changed_this_time = apply_ifelse261(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply_ifelse262(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply_ifelse263(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply_ifelse264(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply_ifelse265(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptor() == "malloc") {
               changed_this_time = apply_malloc266(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptor() == "max") {
               changed_this_time = apply_max267(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply_max268(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptor() == "min") {
               changed_this_time = apply_min269(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply_min270(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptor() == "print_plain") {
               changed_this_time = apply_print_plain271(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptor() == "sqrt") {
               changed_this_time = apply_sqrt272(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
               ...
               if (changed_this_time) break;
               changed_this_time = apply_trunc279(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply_trunc280(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply_trunc281(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply_trunc282(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply_trunc283(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptor() == "whilelim") {
               changed_this_time = apply_whilelim284(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply_whilelim285(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            else if (m->getOptor() == "||") {
               ...
               if (changed_this_time) break;
               changed_this_time = apply__or_295(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply__or_296(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply__or_297(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply__or_298(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
               changed_this_time = apply__or_299(m->toTermIfApplicable(), p);
               if (changed_this_time) break;
            }
            if (!changed_this_time) {
               if (m->getTermsJumpIntoCompounds().size() == 2) {
                  changed_this_time = apply__anyway_operation_232(m->toTermIfApplicable(), p);
                  if (changed_this_time) break;
               }
            }
         }
