...
// Creation time: Mon May  4 10:47:07 2026
...
// 2) Hard-coded simplification via simplification_pos::simplifyFast() in this file: About 300x faster than runtime version.
...
inline bool apply__plus_8(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   if (formula->getOptorOnCompoundLevel() == "+") {
      TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
      TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
      if (formula_1->getOptorOnCompoundLevel() == "-" && formula_1->getTermsJumpIntoCompounds().size() == 2.000000) {
         TermPtr formula_1_0 = formula_1->getTermsJumpIntoCompounds()[0];
         TermPtr formula_1_1 = formula_1->getTermsJumpIntoCompounds()[1];
...
inline bool apply__plus_11(const TermPtr formula, const std::shared_ptr<FormulaParser> p)
{
   if (formula->getOptorOnCompoundLevel() == "+") {
      TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
      TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
      if (formula_0->getOptorOnCompoundLevel() == "-" && formula_0->getTermsJumpIntoCompounds().size() == 2.000000) {
         TermPtr formula_0_0 = formula_0->getTermsJumpIntoCompounds()[0];
         TermPtr formula_0_1 = formula_0->getTermsJumpIntoCompounds()[1];
...
{
   if (formula->getOptorOnCompoundLevel() == "-" && formula->getTermsJumpIntoCompounds().size() == 2.000000) {
      TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
      TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
      if (formula_0->getOptorOnCompoundLevel() == "+") {
         TermPtr formula_0_0 = formula_0->getTermsJumpIntoCompounds()[0];
...
{
   if (formula->getTermsJumpIntoCompounds().size() == 2.000000) {
      TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
      TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
{
   if (formula->getTermsJumpIntoCompounds().size() == 2.000000 && formula->getOptorOnCompoundLevel() == formula->getTermsJumpIntoCompounds()[0]->getOptorOnCompoundLevel()) {
      TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
      TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
      if (formula_0->getTermsJumpIntoCompounds().size() == 2.000000) {
         TermPtr formula_0_0 = formula_0->getTermsJumpIntoCompounds()[0];
         TermPtr formula_0_1 = formula_0->getTermsJumpIntoCompounds()[1];
...
{
   if (formula->getOptorOnCompoundLevel() == "max") {
      TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
      TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
      if (MetaRule::of_first_two_operands_second_is_alphabetically_above(_seq_plain(formula_0, formula_1)) && MetaRule::is_variable(formula_0) && MetaRule::is_variable(formula_1) && MetaRule::no_check(formula)) {
...
{
   if (formula->getOptorOnCompoundLevel() == "min") {
      TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
      TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
      if (MetaRule::of_first_two_operands_second_is_alphabetically_above(_seq_plain(formula_0, formula_1)) && MetaRule::is_variable(formula_0) && MetaRule::is_variable(formula_1) && MetaRule::no_check(formula)) {
...
{
   if (formula->getOptorOnCompoundLevel() == "xnor") {
      TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
      TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
      if (MetaRule::of_first_two_operands_second_is_alphabetically_above(_seq_plain(formula_0, formula_1)) && MetaRule::is_variable(formula_0) && MetaRule::is_variable(formula_1) && MetaRule::no_check(formula)) {
...
{
   if (formula->getOptorOnCompoundLevel() == "xor") {
      TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
      TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
      if (MetaRule::of_first_two_operands_second_is_alphabetically_above(_seq_plain(formula_0, formula_1)) && MetaRule::is_variable(formula_0) && MetaRule::is_variable(formula_1) && MetaRule::no_check(formula)) {
...
{
   if (formula->getTermsJumpIntoCompounds().size() == 2.000000 && formula->getOptorOnCompoundLevel() == formula->getTermsJumpIntoCompounds()[1]->getOptorOnCompoundLevel()) {
      TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
      TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
      if (formula_1->getTermsJumpIntoCompounds().size() == 2.000000) {
         TermPtr formula_1_0 = formula_1->getTermsJumpIntoCompounds()[0];
         TermPtr formula_1_1 = formula_1->getTermsJumpIntoCompounds()[1];
...
{
   if (formula->getOptorOnCompoundLevel() == "abs") {
      TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
      if (formula_0->getOptorOnCompoundLevel() == "--") {
         TermPtr formula_0_0 = formula_0->getTermsJumpIntoCompounds()[0];
         if (MetaRule::no_check(formula)) {
...
{
   if (formula->getOptorOnCompoundLevel() == "boolify") {
      TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
      if (formula_0->getOptorOnCompoundLevel() == "!") {
         TermPtr formula_0_0 = formula_0->getTermsJumpIntoCompounds()[0];
         if (MetaRule::no_check(formula)) {
...
{
   if (formula->getOptorOnCompoundLevel() == "free") {
      TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
...
{
   if (formula->getOptorOnCompoundLevel() == "id") {
      TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
      if (MetaRule::no_check(formula)) {
         formula->replace(formula_0);
         return true;
...
{
   if (formula->getOptorOnCompoundLevel() == "if") {
      TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
      TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
{
   if (formula->getOptorOnCompoundLevel() == "ifelse") {
      TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
      TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
{
   if (formula->getOptorOnCompoundLevel() == "malloc") {
      TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
      if (MetaRule::is_constant_0(formula_0) && MetaRule::no_check(formula)) {
         formula->replace(_val(0.000000));
         return true;
...
{
   if (formula->getOptorOnCompoundLevel() == "print_plain") {
      TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
      TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
...
{
   if (formula->getOptorOnCompoundLevel() == "sqrt") {
      TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
      if (formula_0->getOptorOnCompoundLevel() == "*") {
         TermPtr formula_0_0 = formula_0->getTermsJumpIntoCompounds()[0];
         TermPtr formula_0_1 = formula_0->getTermsJumpIntoCompounds()[1];
...
{
   if (formula->getOptorOnCompoundLevel() == "trunc") {
      TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
      if (formula_0->getOptorOnCompoundLevel() == "!") {
         TermPtr formula_0_0 = formula_0->getTermsJumpIntoCompounds()[0];
         if (MetaRule::no_check(formula)) {
...
{
   if (formula->getOptorOnCompoundLevel() == "whilelim") {
      TermPtr formula_0 = formula->getTermsJumpIntoCompounds()[0];
      TermPtr formula_1 = formula->getTermsJumpIntoCompounds()[1];
      TermPtr formula_2 = formula->getTermsJumpIntoCompounds()[2];
      if (MetaRule::is_constant_and_evaluates_to_false(formula_0) && MetaRule::no_check(formula)) {
...
// Auto-generated simplification function. When freshly generated, it should
// do the same as MathStruct::simplify and simplification_pos::simplify, only faster.
