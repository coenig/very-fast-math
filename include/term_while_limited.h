...
class TermWhileLimited : public TermArith
{
public:
   ...
   TermWhileLimited(const std::vector<std::shared_ptr<Term>>& opds);
   TermWhileLimited(const std::shared_ptr<Term> opd1, const std::shared_ptr<Term> opd2, const std::shared_ptr<Term> opd3);
};
